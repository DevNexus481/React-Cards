  ...
  const cardData = [
    {
      ...
      name: "Amazon Basics.",
      description: "ing elit. Consectetur molestiae cupiditate excepturi.",
      instock: true,
    },
    {
      image:
      ...
      name: "Daily Object.",
      description: "Lorem ipsum, dolor sit amet consectee excepturi.",
      instock: true,
    },
    {
      image:
      ...
      name: "Cyber Punk.",
      description:
        "Lorem ipsum, dolor sitConsectetur molestiae cupiditate excepturi.",
      instock: false,
    },
  ];
      ...
      {cardData.map((value, index) => (
        <div
          ...
          <div className="w-full px-3 py-4">
            ...
            <button
              className={`px-4 py-1 text-xs rounded mt-3 text-zinc-100 ${
                value.instock ? "bg-blue-600" : "bg-red-600"
              }`}>
